...
INSERT INTO treatment_plan (id, treatment_action, subject_patient, start_time, end_time, recurrence_pattern)
VALUES (RANDOM_UUID(), 'ACTION_A', 'patient5', DATEADD('HOUR', 16, CURRENT_DATE), DATEADD('HOUR', 10, DATEADD('DAY', 1, CURRENT_DATE)), '0 0 16 * * *');
INSERT INTO treatment_plan (id, treatment_action, subject_patient, start_time, end_time, recurrence_pattern)
VALUES (RANDOM_UUID(), 'ACTION_B', 'patient6', DATEADD('HOUR', 18, CURRENT_DATE), DATEADD('HOUR', 20, DATEADD('DAY', 1, CURRENT_DATE)), '0 0 */6 * * *');

-- Two plans that already ended
INSERT INTO treatment_plan (id, treatment_action, subject_patient, start_time, end_time, recurrence_pattern)
VALUES (RANDOM_UUID(), 'ACTION_A', 'patient7', DATEADD('HOUR', 8, DATEADD('DAY', -2, CURRENT_DATE)), DATEADD('HOUR', 10, DATEADD('DAY', -1, CURRENT_DATE)), '0 0 16 * * *');
INSERT INTO treatment_plan (id, treatment_action, subject_patient, start_time, end_time, recurrence_pattern)
VALUES (RANDOM_UUID(), 'ACTION_B', 'patient8', DATEADD('HOUR', 12, DATEADD('DAY', -1, CURRENT_DATE)), DATEADD('HOUR', -1, CURRENT_DATE), '0 0 */6 * * *');